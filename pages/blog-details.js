...
const BlogGrid = () => {
    ...
    const getAllBlogs = () => {
        const data_blog = localStorage.getItem('blog_id');
        console.log(data_blog,"jjjjjhbhjbhbhb")
        const url = "http://148.72.214.135:5000/api/blog_data/"+data_blog
        axios.get(url)
            .then((response) => {
                console.log(response.data,"shiiinnaaaaaaaaaaaaa")
                                    ...
                                    <div className="blog-details-desc">
                                        ...
                                        <div className="article-content">
                                            <div className="entry-meta">
                                                <ul>
                                                    <li><span>Posted On:</span> <a href="#">{contact.createdAt}</a></li>
                                            ...
                                            <div className="row mb-3">
                                                ...
                                                <div className="col-lg-4 mt-4">
                                                    <div className="b-d-s-img">
                                                        <img src="http://res.cloudinary.com/sveltose/image/upload/v1614780353/medial/1614780352077.jpg" alt="Image" />
                                                    </div>
                                                </div>
                                            </div>
