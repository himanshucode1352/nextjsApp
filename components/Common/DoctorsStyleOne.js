        ...
        <div className="doctors-area pt-100 pb-70">
			<div className="container">
				<div className="section-title">
					<span className="top-title">Our Doctor</span>
					<h2>Our Specialist Doctors</h2>
					<p>We have hand-pick doctors who are experienced in their field with experience of more than 10 years in their respective fields. Our Doctors will provide you high quality video consultation and detailed prescription.</p>
				</div>
